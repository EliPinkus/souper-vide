...
export const NANO_PAIRING: PairingContent = {
  ...
  troubleshooting: [
    ...
    'Anova’s Gen 3 cookers (Mini, Nano 3.0) may pop a system pairing dialog while connecting. It arrives on its own once you click Connect — there is nothing to go looking for — and declining it makes the cooker hang up.',
...
export const CHOOSER_NOTE =
  'Neither device will appear in your operating system’s Bluetooth settings, in any mode — that list is for keyboards and headphones, not GATT peripherals like these. Its absence there is normal, not a fault. Connect them here instead; Chrome talks to them directly.';
